const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/FloatingRocket-BQiG8dOO.js","assets/react-core-CPHnqsFW.js","assets/markdown-DNQhOqsY.js","assets/styled-CHfxRgpd.js","assets/icons-DNJk4BLK.js","assets/framer-DRpzP9-u.js","assets/RandomTelemetry-CELGgXYZ.js","assets/react-vendor-BakkmLcC.js","assets/WorldMap-CUoF2Kkz.js"])))=>i.map(i=>d[i]);
import{r as d,j as e,R as me}from"./react-core-CPHnqsFW.js";import{u as he,a as ge,b as Te,L as Ce,B as Ae,R as Oe,c as U,d as Ee}from"./react-vendor-BakkmLcC.js";import{f as Pe,d as t,m as G}from"./styled-CHfxRgpd.js";import{H as Fe,a as Me,F as Y,b as Re,M as Le,B as We,c as He,d as X,e as Be,f as De,g as ue,h as $e,i as xe,j as E,k as _e,l as qe,m as k,n as Ne,o as Ge,p as Ve,q as Ue,r as Ye,s as L,t as Xe,u as Je,v as Ke,w as Qe,x as Ze,y as et,z as tt}from"./icons-DNJk4BLK.js";import{m as l,u as it,a as at,A as j}from"./framer-DRpzP9-u.js";import{M as ot,g as rt}from"./markdown-DNQhOqsY.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function r(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(n){if(n.ep)return;n.ep=!0;const s=r(n);fetch(n.href,s)}})();const nt="modulepreload",st=function(i){return"/urvin.github.io/"+i},J={},P=function(o,r,a){let n=Promise.resolve();if(r&&r.length>0){let x=function(p){return Promise.all(p.map(h=>Promise.resolve(h).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),m=c?.nonce||c?.getAttribute("nonce");n=x(r.map(p=>{if(p=st(p),p in J)return;J[p]=!0;const h=p.endsWith(".css"),g=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${g}`))return;const u=document.createElement("link");if(u.rel=h?"stylesheet":nt,h||(u.as="script"),u.crossOrigin="",u.href=p,m&&u.setAttribute("nonce",m),document.head.appendChild(u),h)return new Promise((f,b)=>{u.addEventListener("load",f),u.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${p}`)))})}))}function s(c){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=c,window.dispatchEvent(m),!m.defaultPrevented)throw c}return n.then(c=>{for(const m of c||[])m.status==="rejected"&&s(m.reason);return o().catch(s)})},lt=Pe`
  :root {
...
`,Mt=()=>{const{slug:i}=Te(),o=he(),r=It(i);d.useEffect(()=>{window.scrollTo(0,0)},[i]);const a=()=>{o("/#blog")},n=async()=>{const c=window.location.href;if(navigator.share)try{await navigator.share({title:r?.title||"Blog Post",text:r?.summary||"",url:c})}catch(m){console.log("Error sharing:",m)}else navigator.clipboard.writeText(c),alert("Link copied to clipboard!")},s=c=>{o(`/#${c}`)};return r?e.jsxs(Q,{children:[e.jsx(Z,{}),e.jsx(N,{scrollToSection:s}),e.jsx(ee,{children:e.jsxs(te,{children:[e.jsxs(ie,{children:[e.jsxs(ae,{onClick:a,whileHover:{scale:1.05},children:[e.jsx(Y,{})," Back to Blog"]}),e.jsxs(zt,{onClick:n,whileHover:{scale:1.05},children:[e.jsx(Re,{})," Share"]})]}),e.jsxs(Tt,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.6,ease:"easeOut"},children:[e.jsxs(Ct,{children:[r.category&&e.jsx(At,{children:r.category}),e.jsx(Ot,{children:r.title}),e.jsxs(Et,{children:[e.jsxs("span",{children:[e.jsx(Le,{})," ",r.date]}),e.jsxs("span",{children:[e.jsx(We,{})," ",r.readTime]})]})]}),e.jsx(Pt,{children:e.jsx(ot,{components:{a:({node:c,...m})=>e.jsx("a",{...m,target:"_blank",rel:"noopener noreferrer"})},children:r.content})})]})]})})]}):e.jsxs(Q,{children:[e.jsx(Z,{}),e.jsx(N,{scrollToSection:s}),e.jsx(ee,{children:e.jsxs(te,{children:[e.jsx(ie,{children:e.jsxs(ae,{onClick:a,whileHover:{scale:1.05},children:[e.jsx(Y,{})," Back to Blog"]})}),e.jsxs(Ft,{children:[e.jsx("h2",{children:"Blog Post Not Found"}),e.jsx("p",{children:"The blog post you're looking for doesn't exist."})]})]})})]})};var W={exports:{}},H,oe;function Rt(){if(oe)return H;oe=1;var i="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";return H=i,H}var B,re;function Lt(){if(re)return B;re=1;var i=Rt();function o(){}function r(){}return r.resetWarningCache=o,B=function(){function a(c,m,x,p,h,g){if(g!==i){var u=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw u.name="Invariant Violation",u}}a.isRequired=a;function n(){return a}var s={array:a,bigint:a,bool:a,func:a,number:a,object:a,string:a,symbol:a,any:a,arrayOf:n,element:a,elementType:a,instanceOf:n,node:a,objectOf:n,oneOf:n,oneOfType:n,shape:n,exact:n,checkPropTypes:r,resetWarningCache:o};return s.PropTypes=s,s},B}var ne;function Wt(){return ne||(ne=1,W.exports=Lt()()),W.exports}var Ht=Wt();const v=rt(Ht),ve=d.createContext(),Bt=()=>{const i=d.useContext(ve);if(!i)throw new Error("useToast must be used within ToastProvider");return i},Dt=G`
  from {
...
`,Na=[{id:1,title:"Predictive Decision-Support Models",role:"Product Lead",description:"Designed multiple predictive models serving as essential decision-support tools for airport stations, the Network Operations Center (NOC), and stakeholders. Led to significant improvements in on-time performance and service reliability.",image:"/images/projects/predictive.webp",fallbackIcon:"📊",stats:[{icon:e.jsx(L,{}),text:"NOC & stations alignment"},{icon:e.jsx(E,{}),text:"Real-time predictive forecasting"}],link:"https://www.united.com"},{id:2,title:"Enterprise API & Messaging Platform Integration",role:"Operations Platform Manager",description:"Formulated and managed multi-year strategic roadmaps for enterprise API management and messaging platforms. Ensured tech capabilities scale dynamically with evolving airline operations and high-volume data streams.",image:"/images/projects/api-platform.webp",fallbackIcon:"🌐",stats:[{icon:e.jsx(L,{}),text:"Cross-functional engineering alignment"},{icon:e.jsx(E,{}),text:"Enterprise scale API scaling"}],link:"https://www.united.com"},{id:3,title:"Spotfire Analytics Platform Governance",role:"Analytics Governance Lead",description:"Provided governance for Spotfire analytics platforms across airports. Expanded utilization to enhance operational transparency, providing dashboards for executive decision support.",image:"/images/projects/spotfire.webp",fallbackIcon:"📈",stats:[{icon:e.jsx(L,{}),text:"Used by MD, VP, and SVP-level leaders"},{icon:e.jsx(Xe,{}),text:"Substantial resource & cost optimization"}],link:"https://www.united.com"}],Ga={hidden:{opacity:0,y:20},visible:{opacity:1,y:0,transition:{duration:.6,ease:"easeOut"}}},Va={hidden:{opacity:0,y:30},visible:i=>({opacity:1,y:0,transition:{duration:.55,delay:i*.12,ease:"easeOut"}})},Ua=({src:i,alt:o,fallback:r})=>{const[a,n]=d.useState(!1);return e.jsx(Ma,{children:a?e.jsx(La,{children:r}):e.jsx(Ra,{src:i,alt:o,loading:"lazy",onError:()=>n(!0)})})},Ya=()=>e.jsx(Ca,{id:"projects",children:e.jsxs(Aa,{children:[e.jsxs(Oa,{variants:Ga,initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.15},children:[e.jsx(Ea,{children:"Featured Projects"}),e.jsx(Pa,{children:"Key initiatives in airport automation, operational analytics, and system scaling"})]}),e.jsx(Fa,{children:Na.map((i,o)=>e.jsxs(ke,{custom:o,variants:Va,initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.15},whileHover:{y:-5},children:[e.jsx(Ua,{src:i.image,alt:i.title,fallback:i.fallbackIcon}),e.jsxs(Wa,{children:[e.jsx(Ha,{children:i.title}),e.jsx(Ba,{children:i.role}),e.jsx(Da,{children:i.description}),e.jsx($a,{children:i.stats.map((r,a)=>e.jsxs(_a,{children:[r.icon,e.jsx("span",{children:r.text})]},a))}),i.link&&i.link!=="#"&&e.jsxs(qa,{href:i.link,target:"_blank",rel:"noopener noreferrer",children:["Visit Website",e.jsx(Ye,{size:12})]})]})]},i.id))})]})}),je=t(l.article)`
  background: var(--color-bg-card);
  border: 1px solid var(--color-border);
  border-radius: 16px;
  padding: var(--spacing-lg);
...
`;t.div`
  ...
  padding-top: var(--spacing-md);
  border-top: 1px solid var(--color-border);
`;v.string,v.string,v.node;const Ja=i=>Array.isArray(i)?[...i].sort((o,r)=>{const a=new Date(o.date);return new Date(r.date)-a}):[],$={container:{hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.2,delayChildren:.3}}},item:{hidden:{opacity:0,y:30},visible:{opacity:1,y:0,transition:{duration:.6,ease:"easeOut"}}}},O={sectionTitle:"Writings",sectionSubtitle:"A collection of thoughts and insights",quote:{text:"As for the future, your task is not to foresee it, but to enable it.",author:"Antoine de Saint-Exupéry"}},Ka=t.section`
  padding: var(--spacing-2xl) 0;
  position: relative;
  background: transparent;
  overflow: hidden;
...
`,Po=()=>{const{formState:i,isSubmitting:o,emailError:r,handleChange:a,handleSubmit:n}=lo(),s={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.2,delayChildren:.3}}},c={hidden:{opacity:0,y:30},visible:{opacity:1,y:0,transition:{duration:.6,ease:"easeOut"}}},m=[{icon:e.jsx(Ze,{}),label:"Location",value:"Cary, Illinois, USA"},{icon:e.jsx(et,{}),label:"Current Position",value:"Senior Manager, United Airlines"},{icon:e.jsx(tt,{}),label:"Languages",value:"English"}],x=[{icon:e.jsx(ue,{}),url:"https://www.linkedin.com/in/kapadia-urvin-848a97a1/",label:"LinkedIn"}];return e.jsx(co,{children:e.jsxs(po,{children:[e.jsx(mo,{variants:s,initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},children:e.jsxs(l.div,{variants:c,children:[e.jsx(ho,{children:"Get In Touch"}),e.jsx(go,{children:"Let's connect and build something amazing together"})]})}),e.jsxs(uo,{children:[e.jsxs(xo,{variants:s,initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},children:[e.jsxs(l.div,{variants:c,children:[e.jsx(fo,{children:"Let's Connect"}),e.jsx(de,{children:"Whether you want to discuss technology, engineering, or just say hello, I'd love to hear from you. Feel free to reach out through the form or connect on social media."})]}),m.map((p,h)=>e.jsxs(vo,{variants:c,whileHover:{scale:1.02},children:[e.jsx(bo,{children:p.icon}),e.jsxs(yo,{children:[e.jsx(wo,{children:p.label}),e.jsx(ko,{children:p.value})]})]},h)),e.jsxs(l.div,{variants:c,children:[e.jsx(de,{children:"Connect with me on social media:"}),e.jsx(jo,{children:x.map((p,h)=>e.jsx(A,{range:35,children:e.jsx(So,{href:p.url,target:"_blank",rel:"noopener noreferrer","aria-label":p.label,whileHover:{scale:1.1},whileTap:{scale:.9},children:p.icon})},h))})]})]}),e.jsx(To,{variants:c,initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},children:e.jsxs(Co,{onSubmit:n,children:[e.jsxs(_,{children:[e.jsx(q,{htmlFor:"name",children:"Your Name"}),e.jsx(pe,{type:"text",id:"name",name:"name",value:i.name,onChange:a,placeholder:"John Doe",required:!0,disabled:o})]}),e.jsxs(_,{children:[e.jsx(q,{htmlFor:"email",children:"Email Address"}),e.jsx(pe,{type:"email",id:"email",name:"email",value:i.email,onChange:a,placeholder:"john@example.com",required:!0,disabled:o,style:r?{borderColor:"#ef4444"}:{}}),r&&e.jsx(Eo,{children:r})]}),e.jsxs(_,{children:[e.jsx(q,{htmlFor:"message",children:"Message"}),e.jsx(Ao,{id:"message",name:"message",value:i.message,onChange:a,placeholder:"Tell me about yourself or just say hi!",rows:"5",required:!0,disabled:o})]}),e.jsx(Oo,{type:"submit",disabled:o,whileHover:o?{}:{scale:1.02},whileTap:o?{}:{scale:.98},children:o?e.jsxs(e.Fragment,{children:[e.jsx(zo,{}),"Sending..."]}):e.jsxs(e.Fragment,{children:[e.jsx(Qe,{}),"Send Message"]})})]})})]})]})})},Fo=t.canvas`
  ...
  z-index: 9999;
  pointer-events: none;
`;class Mo{constructor(){this.pool=[],this.active=[]}obtain(o,r){let a;return this.pool.length>0?(a=this.pool.pop(),a.reset(o,r)):a=new Ho(o,r),this.active.push(a),a}recycle(o){const r=this.active[o];this.active.splice(o,1),this.pool.push(r)}clear(){this.active=[]}}const Se=(i,o,r)=>{const n=document.createElement("canvas");n.width=128,n.height=128;const s=n.getContext("2d"),c=128/2,m=s.createRadialGradient(c,c,1,c,c,c);return m.addColorStop(0,`rgba(${i}, ${o}, ${r}, 1)`),m.addColorStop(.25,`rgba(${i}, ${o}, ${r}, 0.4)`),m.addColorStop(1,`rgba(${i}, ${o}, ${r}, 0)`),s.fillStyle=m,s.beginPath(),s.arc(c,c,c,0,Math.PI*2),s.fill(),n},Ro=[{r:6,g:182,b:212},{r:236,g:72,b:153},{r:139,g:92,b:246},{r:148,g:163,b:184}],Lo=Ro.map(i=>Se(i.r,i.g,i.b)),Wo=Se(244,246,249);class Ho{constructor(o,r){this.reset(o,r),this.maxSize=Math.max(window.innerWidth,window.innerHeight)*.95}reset(o,r){this.x=o,this.y=r,this.size=Math.random()*6+3,this.speedX=(Math.random()-.5)*6,this.speedY=Math.random()*3+1.5,this.opacity=.95,this.growth=Math.random()*5+4;const a=Math.random();a<.25?this.colorIndex=0:a<.5?this.colorIndex=1:a<.75?this.colorIndex=2:this.colorIndex=3}update(){this.x+=this.speedX,this.y+=this.speedY,this.size+=this.growth,this.speedX*=.96,this.speedY*=.96,this.opacity-=.015}draw(o){if(this.opacity<=0)return;o.save();const r=Math.min(1,(.95-this.opacity)/.7),a=Lo[this.colorIndex];o.globalAlpha=this.opacity*(1-r*.65),o.drawImage(a,this.x-this.size,this.y-this.size,this.size*2,this.size*2),o.globalAlpha=this.opacity*r*.65,o.drawImage(Wo,this.x-this.size,this.y-this.size,this.size*2,this.size*2),o.restore()}}const Bo=()=>{const i=d.useRef(null),[o,r]=d.useState(!1),a=d.useRef(new Mo);return d.useEffect(()=>{const n=()=>{r(!0),a.current.clear()};return window.addEventListener("rocket-launch",n),()=>{window.removeEventListener("rocket-launch",n)}},[]),d.useEffect(()=>{if(!o)return;const n=i.current;if(!n)return;const s=n.getContext("2d",{alpha:!0});if(!s)return;(()=>{n.width=window.innerWidth,n.height=window.innerHeight})();const m=u=>{const{x:f,y:b}=u.detail;for(let w=0;w<2;w++)a.current.obtain(f+(Math.random()-.5)*10,b+(Math.random()-.5)*6)};window.addEventListener("rocket-emit-smoke",m);let x,p=Date.now(),h=!1;const g=()=>{s.clearRect(0,0,n.width,n.height);const u=Date.now()-p,f=a.current;for(let b=f.active.length-1;b>=0;b--){const w=f.active[b];w.update(),w.draw(s),(w.opacity<=0||w.size>w.maxSize)&&f.recycle(b)}if(u>550&&!h){h=!0;const b=document.getElementById("about");b&&b.scrollIntoView({behavior:"smooth"})}u>800&&f.active.length===0?(r(!1),s.clearRect(0,0,n.width,n.height)):x=requestAnimationFrame(g)};return x=requestAnimationFrame(g),()=>{cancelAnimationFrame(x),window.removeEventListener("rocket-emit-smoke",m)}},[o]),e.jsx(Fo,{ref:i})},Do=(i=1500)=>{const[o,r]=d.useState(!1);return d.useEffect(()=>{let a;return"requestIdleCallback"in window?a=requestIdleCallback(()=>r(!0),{timeout:i}):a=setTimeout(()=>r(!0),i),()=>{"cancelIdleCallback"in window?cancelIdleCallback(a):clearTimeout(a)}},[i]),o},$o=t.div`
  position: relative;
  min-height: 100vh;
  overflow: hidden;
`,_o=t.main`
